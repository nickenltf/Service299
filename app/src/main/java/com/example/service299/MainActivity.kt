package com.example.service299
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_facebook.setOnClickListener({
            val i = Intent(Intent.ACTION_VIEW,
                Uri.parse("http://www.facebook.com/nlutfyanis"))
            startActivity(i)
        })
        ...
        btn_instagram.setOnClickListener({
            val i = Intent(Intent.ACTION_VIEW,
                Uri.parse("http://www.instagram.com/nickenltf"))
            startActivity(i)
        })

        //Mendeklarasikan variabel MediaPlayer dan memanggil data mp3
        var MediaPlayer: MediaPlayer? = MediaPlayer.create(this,R.raw.memories)
